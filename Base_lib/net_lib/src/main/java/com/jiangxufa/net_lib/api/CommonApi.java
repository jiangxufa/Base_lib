...
//     */
//    @GET("appconfig")
//    Observable<DoResponse1<AppConfig>> getAppConfig(@Query("appType") int appType);
//
//    /**
//     * @param code         应用版本号
//     * @param appType      应用类型
...
//    @FormUrlEncoded
//    @POST("user/account")
//    Observable<DoResponse1<Account>> login(@Field("identitykey") String identitykey, @Field("password") String password);
//
//    /**
//     * 发送短信验证码
//     *
...
//    @FormUrlEncoded
//    @POST("captcha")
//    Observable<DoResponse1<String>> sendCaptcha(@Field("identitykey") String identitykey,
...
//    @FormUrlEncoded
//    @POST("tempauth")
//    Observable<DoResponse1<String>> sendTempauth(@Field("captchaId") String captchaId,
...
//    @FormUrlEncoded
//    @PUT("user/password")
//    Observable<DoResponse1<String>> modifyPassword(@Field("tempauth") String tempauth,
