package com.jiangxufa.fa_lib.utils;
 ...
 * 创建时间：2018/6/26
 * 编写人：lenovo
 * 功能描述：Android SDK中Selector对应的Java类是android.graphics.drawable.StateListDrawable，
 * 对于Selector下的每一个item我们使用addState的方式来添加
 * <p>
 * 添加一个state_pressed=true时背景色为蓝色的item，我们可以采用这段代码
 * <p>
